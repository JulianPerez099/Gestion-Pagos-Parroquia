...
<div class="container-fluid">
    <form action="" id="manage-student">
        ...
        <div class="form-group">
            <label for="" class="control-label">Nº Propietario</label>
        ...
        <div class="form-group">
            <label for="" class="control-label">Numero Documento Identificación</label>
            <input type="text" class="form-control" name="num_iden" value="<?php echo isset($num_iden) ? $num_iden : '' ?>" required>
        </div>
        ...
        <div class="form-group">
            <label for="" class="control-label">Numero de Celular</label>
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp == 1) {
                    ...
                    $('#msg').html('<div class="alert alert-danger mx-2">Propietario existe actualmente </div>')
                    end_load()
                }
            }
        })
